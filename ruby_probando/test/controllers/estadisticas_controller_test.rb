...
class EstadisticasControllerTest < ActionController::TestCase
  ...
  test "should create estadistica" do
    assert_difference('Estadistica.count') do
      post :create, estadistica: { clasificacion: @estadistica.clasificacion, derrotas: @estadistica.derrotas, empates: @estadistica.empates, victorias: @estadistica.victorias }
    end
  ...
  test "should update estadistica" do
    patch :update, id: @estadistica, estadistica: { clasificacion: @estadistica.clasificacion, derrotas: @estadistica.derrotas, empates: @estadistica.empates, victorias: @estadistica.victorias }
    assert_redirected_to estadistica_path(assigns(:estadistica))
  end
